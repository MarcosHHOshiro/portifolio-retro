          ...
          <div className="grid items-start gap-8 xl:grid-cols-[minmax(0,1.78fr)_minmax(340px,0.92fr)] xl:gap-0">
            <div className="px-4 py-4 md:px-6 md:py-6 xl:px-8 xl:py-6 xl:pr-7">
              <div className="max-w-[54rem] space-y-6">
                ...
                <div className="h-px w-20 bg-[#d9dee5]" />

                <p className="max-w-[50ch] text-xl leading-[1.5] text-[#5f6b7e] md:max-w-[42ch] md:text-[2rem] md:leading-[1.48] xl:max-w-[52ch] xl:text-[1.06rem]">
            ...
            <div className="hidden self-start border-t-2 border-[#1f1f1f] px-4 py-6 md:px-6 xl:block xl:border-t-0 xl:border-l-2 xl:px-5 xl:pt-4">
              <div className="space-y-4 text-[#202020]">
                ...
                <h2 className="max-w-[11ch] text-[2.7rem] leading-[1.08] font-bold tracking-[-0.06em] text-[#232323]">
                        ...
                        >
                          ...
                          <span
                            className={`flex min-h-[26px] items-center gap-2 px-2 ${
                              item.active
                                ? "bg-[#f3f5f8] text-[#303030]"
                                : item.highlighted
                                  ? "bg-[#fff1f1] text-[#e46d69]"
                                  : "text-[#97a1af]"
                            }`}
                          >
                            {item.type === "file" ? (
                              <>
                                <FileText
                                  className={`h-[13px] w-[13px] shrink-0 ${
                                    item.highlighted ? "text-[#ff7e79]" : "text-[#aeb7c3]"
                                  }`}
                                  strokeWidth={1.8}
                                />
                                <span className={item.highlighted ? "font-medium text-[#e46d69]" : undefined}>
                                  {item.label}
                                </span>
                              </>
                            ) : isProjectChild ? (
